Package.describe({
  ...
  summary: 'A wrapper for of sergeyt:typeahead for autoform of collection with reference to other collection',
  // URL to the Git repository containing the source code for this package.
  git: 'git@github.com:ronenm/meteor-autoform-reference-typeahead.git',
